...
const navigationItems = [
  {
    ...
    label: "La journée Séminaire",
    icon: "/images/picto-mystere.png",
    shortLabel: "Journée Séminaire",
  },
  {
    id: "format",
    label: "Le format",
  ...
  {
    id: "ateliers-seminaire",
    label: "Ateliers Journée Séminaire",
...
export default function JourneeSeminaireLocalNavigation() {
  // start on the first section of THIS page
  const [activeSection, setActiveSection] = useState<string>("journee-securite")
