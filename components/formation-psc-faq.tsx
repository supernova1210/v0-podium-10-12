...
export default function FormationPscFAQ() {
  ...
  return (
    <section id="faq" className="scroll-mt-20 py-16 md:py-20 bg-white border-t border-gray-100 relative overflow-hidden">
      ...
      <div aria-hidden className="absolute left-[-45px] top-28 hidden xl:block w-40 h-40 rounded-[34px] bg-[#FFD25D]/12" />
      <div aria-hidden className="absolute left-20 top-52 hidden xl:block w-24 h-24 rounded-[24px] border-2 border-[#061952]/[0.08]" />
      <div aria-hidden className="absolute right-[-40px] bottom-24 hidden xl:block w-44 h-44 rounded-[36px] border-2 border-[#FFD25D]/25" />
      <div aria-hidden className="absolute right-24 bottom-44 hidden xl:block w-20 h-20 rounded-[22px] bg-[#061952]/[0.04]" />
