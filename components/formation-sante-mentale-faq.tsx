...
const faqData = [
  {
    ...
    answer:
      "À toute personne en lien avec des usagers, des bénéficiaires ou des collègues (professionnels du soin, de l’aide à domicile, du social, managers et encadrants) souhaitant développer une posture d’écoute et de vigilance face aux signes de mal-être.",
  },
  {
    question: "Quel format et quelle durée ?",
    answer:
      "Formation intra-entreprise, en présentiel, d’une durée de 3h. Groupes de 4 à 12 participants.",
  },
  {
    question: "Quelles sont les modalités et le tarif ?",
    answer:
      "Démarrage après signature du devis. Tarif sur devis et délais selon votre projet. Un certificat de réalisation est transmis à chaque participant en fin de formation. Adaptations possibles pour les personnes en situation de handicap.",
  },
]

export default function FormationSanteMentaleFAQ() {
