      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="relative max-w-sm mx-auto lg:max-w-[460px] lg:ml-auto w-full">
            ...
            <div className="absolute z-20 bottom-6 -left-4 sm:-left-7 bg-white rounded-2xl px-4 py-3 shadow-[0_18px_50px_rgba(6,25,82,0.16)] flex items-center gap-3 max-w-[240px]">
              <span className={`w-11 h-11 rounded-xl bg-[#061952] flex items-center justify-center flex-shrink-0 ${a.floatIcon}`}>
                <Sparkles className="w-6 h-6" />
              </span>
              <div>
                <div className="font-poppins font-semibold text-sm text-[#061952] leading-tight">Clé en main</div>
                <div className="text-xs text-gray-500">animé dans vos locaux</div>
              </div>
            </div>
          </div>
        </div>
