export const reveilMusculaireData = {
  hero: {
    ...
    image: {
      ...
      alt: "Groupe de personnes participant à un atelier de réveil musculaire dans un espace moderne et lumineux",
    },
    ctas: [
      {
      ...
      },
      {
        ...
        href: "/documents/atelier-reveil-musculaire-ludique.pdf",
